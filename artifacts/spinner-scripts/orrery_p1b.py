"""ORRERY 90 - part 1b: ring gear + journal post.
...
def run(_context: str):
    ...
    if stator is None or root.bRepBodies.count != 1:
        raise RuntimeError("expected exactly or_stator from part 1a")
    print("FH P1b resuming on base %.3f cm3" % stator.volume)

    # ---- 50-tooth internal ring gear wall ------------------------------
